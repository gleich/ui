...
<main>
	...
	<section>
		...
		<div class="colors">
			<Color variable="--green-foreground" />
			...
			<Color variable="--button-background" />
	...
	<section>
		<h2>&lt;Layout/&gt;</h2>
		<p>
			Aligns the content to the middle, makes the width max out at 1040px, and adds padding in all
			directions.
		</p>
	</section>
